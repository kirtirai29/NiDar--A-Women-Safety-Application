...
public class Magnetometer extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (magnetometer != null){
            ...
            magR.setText(R.string.MagnetometernotSupported);
        }
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (sensor.getType() == Sensor.TYPE_MAGNETIC_FIELD){
            ...
            if(Double.compare (x,Pd)>0 && Double.compare (x,Fd)<0) {
                ...
                mediaPlayer.start();
                show_conditions.setText( R.string.PotentialElectronicDeviceDetected );
                ...
                mediaPlayer.start();
                show_conditions.setText( R.string.Finallyelectronicdevicedetected );

            }else {
                mediaPlayer = null;
                show_conditions.setText (getString(R.string.NoDevice));
            }
