...
public class SmsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tryit=findViewById(R.id.button);
...
//                v=(Vibrator)context.getSystemService(Context.VIBRATOR_SERVICE);
        ...
        String Value = getShared.getString ("msg", getString(R.string.dangerMess));
...
//saving data code demo ends here
    ...
    public  void tryIt(){
        if(!txt_pnumber1.getText ().toString ().trim ().equals ("")) {
             ...
             */
            if (ContextCompat.checkSelfPermission (SmsActivity.this, android.Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED) {
                makeCall ();
            } else {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    ...
                    try {
                        ...
                        +"\n Google Map url: "+"http://maps.google.com/maps?q="+addresses.get (0).getLatitude ()+","+addresses.get (0).getLongitude () ;
